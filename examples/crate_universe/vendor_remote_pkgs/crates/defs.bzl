...
_NORMAL_DEPENDENCIES = {
    "": {
        _COMMON_CONDITION: {
            ...
            "serde_json": Label("@crates_vendor_pkgs__serde_json-1.0.120//:serde_json"),
            "socket2": Label("@crates_vendor_pkgs__socket2-0.4.10//:socket2"),
            "tokio": Label("@crates_vendor_pkgs__tokio-1.39.1//:tokio"),
...
def crate_repositories():
    ...
    maybe(
        http_archive,
        name = "crates_vendor_pkgs__bytes-1.6.1",
        ...
        build_file = Label("@examples//vendor_remote_pkgs/crates:BUILD.bytes-1.6.1.bazel"),
    )

    maybe(
        http_archive,
        name = "crates_vendor_pkgs__cc-1.1.6",
        ...
        build_file = Label("@examples//vendor_remote_pkgs/crates:BUILD.cc-1.1.6.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "crates_vendor_pkgs__httparse-1.9.4",
        ...
        build_file = Label("@examples//vendor_remote_pkgs/crates:BUILD.httparse-1.9.4.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "crates_vendor_pkgs__hyper-0.14.30",
        ...
        build_file = Label("@examples//vendor_remote_pkgs/crates:BUILD.hyper-0.14.30.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "crates_vendor_pkgs__proc-macro2-1.0.86",
        ...
        build_file = Label("@examples//vendor_remote_pkgs/crates:BUILD.proc-macro2-1.0.86.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "crates_vendor_pkgs__serde_json-1.0.120",
        ...
        build_file = Label("@examples//vendor_remote_pkgs/crates:BUILD.serde_json-1.0.120.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "crates_vendor_pkgs__tokio-1.39.1",
        sha256 = "d040ac2b29ab03b09d4129c2f5bbd012a3ac2f79d38ff506a4bf8dd34b0eac8a",
        type = "tar.gz",
        urls = ["https://static.crates.io/crates/tokio/1.39.1/download"],
        strip_prefix = "tokio-1.39.1",
        build_file = Label("@examples//vendor_remote_pkgs/crates:BUILD.tokio-1.39.1.bazel"),
    )
    ...
    return [
        ...
        struct(repo = "crates_vendor_pkgs__serde_json-1.0.120", is_dev_dep = False),
        struct(repo = "crates_vendor_pkgs__socket2-0.4.10", is_dev_dep = False),
        struct(repo = "crates_vendor_pkgs__tokio-1.39.1", is_dev_dep = False),
