...
_NORMAL_DEPENDENCIES = {
    "vendor_remote_manifests": {
        _COMMON_CONDITION: {
            "tokio": Label("@cvm__tokio-1.39.1//:tokio"),
        },
    },
}
...
def crate_repositories():
    ...
    maybe(
        ...
        build_file = Label("@examples//vendor_remote_manifests/crates:BUILD.bytes-1.6.1.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@examples//vendor_remote_manifests/crates:BUILD.cc-1.1.6.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("@examples//vendor_remote_manifests/crates:BUILD.tokio-1.39.1.bazel"),
    )
    ...
    return [
        struct(repo = "cvm__tokio-1.39.1", is_dev_dep = False),
